...
spec:
  ...
  sourceFiles:
    ...
    - fileName: DefaultCatsrc.yaml
      ...
      spec:
        image: infra.5g-deployment.lab:8443/redhat/redhat-operator-index:v4.12-1677697786
      policyName: config-policies
