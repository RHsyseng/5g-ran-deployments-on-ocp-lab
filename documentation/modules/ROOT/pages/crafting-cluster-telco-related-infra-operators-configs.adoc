...
In this lab we have extra content for a secret required by our Cluster Logging configuration. Let's first extract the predefined source-crs from the ztp-generate container {lab-major-version} version to the reference-crs folder.
