...
WARNING: There is no ARM version of the ztp-site-generate-rhel8 container image. So if you are running the lab on an ARM laptop, remember to enable https://gist.github.com/alosadagrande/b5cb12d5acb467d8f22e8c462d0f05a0[multi-architecture support].
