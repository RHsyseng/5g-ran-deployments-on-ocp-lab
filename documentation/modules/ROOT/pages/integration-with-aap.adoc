...
* Upload necessary Ansible collections to Automation Hub (already uploaded, see uploaded collections at https://automation-hub-aap.apps.hub.5g-deployment.lab)
