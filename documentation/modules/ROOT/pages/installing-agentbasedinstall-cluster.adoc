...
2. When accessing choose `Log in via OpenShift`. On the next screen use the OpenShift Console Admin credentials.
...
2. In the top-left corner, click on `Fleet Management` to enter the RHACM console.
