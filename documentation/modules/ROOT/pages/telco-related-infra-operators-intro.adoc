...
You can read more about the NTO https://docs.openshift.com/container-platform/4.12/scalability_and_performance/using-node-tuning-operator.html[here].
...
You can read more about the SR-IOV operator https://docs.openshift.com/container-platform/4.12/networking/hardware_networks/about-sriov.html[here].
...
* https://docs.openshift.com/container-platform/4.12/networking/using-ptp.html[PTP Operator Official Docs].
