...
[root@hypervisor ~]# dnf -y install kcli bash-completion vim jq
-----
...
[source,bash,subs="attributes+,+macros"]
-----
[root@hypervisor ~]# curl -L https://mirror.openshift.com/pub/openshift-v4/x86_64/clients/ocp/latest-4.11/openshift-client-linux.tar.gz -o openshift-client-linux.tar.gz
[root@hypervisor ~]# tar xvfz openshift-client-linux.tar.gz kubectl oc
[root@hypervisor ~]# mv kubectl oc /usr/bin/
[root@hypervisor ~]# rm -f openshift-client-linux.tar.gz
-----
...
[source,bash,subs="attributes+,+macros"]
-----
[root@hypervisor ~]# curl -L http://infra.5g-deployment.lab:3000/student/5g-ran-deployments-on-ocp-lab/raw/branch/main/lab-materials/helper-data/ssh-key -o /root/.ssh/snokey
