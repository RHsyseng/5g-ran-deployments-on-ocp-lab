...
If you still need to deploy a lab environment, follow the guide available xref:lab-environment.adoc[here].
...
A https://docs.openshift.com/container-platform/4.12/installing/disconnected_install/installing-mirroring-creating-registry.html[container registry] is running on the infrastructure host, you can reach it out at https://infra.5g-deployment.lab:8443/.
