...
* Username: `admin` 
* Password: The password is randomly generated for each environment, and can be found in the email from demo.redhat.com or in case you configured the lab yourself, you defined this password.
