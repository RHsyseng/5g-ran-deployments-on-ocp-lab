...
IMPORTANT: We're using the `kcli` tool to boot the server from the ISO by leveraging the RedFish API. You can boot the server using other methods as needed.
