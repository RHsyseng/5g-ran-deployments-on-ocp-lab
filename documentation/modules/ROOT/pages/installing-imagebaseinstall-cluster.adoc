...
+
image::ibi-cluster-app-sno3.png[ArgoCD Clusters App]
+
5. You can see how the pipeline created all the required objects to get `sno3` deployed. Notice as well that the `sno2` objects are there from link:installing-agentbasedinstall-cluster.html#deploying-sno-using-gitops-pipeline[previous configuration].
