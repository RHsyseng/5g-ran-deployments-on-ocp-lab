...
Feb 04 10:37:53 ocp-sno-ibi install-rhcos-and-restore-seed.sh[1625]: Trying to pull infra.5g-deployment.lab:8443/ibi/lab5gran:v4.18.0-rc.7...
...
[source,bash,subs="attributes+,+macros"]
-----
watch oc --kubeconfig {ibi-cluster-kubeconfig} get clusterversion,nodes,mcp,co
-----
