...
[source,bash,subs="attributes+,+macros"]
-----
HTPASS_USER=$(htpasswd -n lab-user)
HYPERVISOR_PUBLIC_HOSTNAME=<PUT_HERE_PUBLIC_HOSTNAME_OR_IP>
...
At this point if we access the hypervisor public hostname in the https port in our web browser we should get the lab instructions, a terminal and a browser on screen.
