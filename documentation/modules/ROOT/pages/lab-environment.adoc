...
[source,bash,subs="attributes+,+macros"]
-----
curl https://raw.githubusercontent.com/{gh-user}/5g-ran-deployments-on-ocp-lab/{gh-branch}/aap-integration-tools/collections/collections_to_hub.bash -o ~/collections_to_hub.bash
-----
