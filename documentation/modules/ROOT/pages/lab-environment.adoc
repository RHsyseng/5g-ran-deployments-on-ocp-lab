...
IMPORTANT: The /opt directory requires a minimum of 60 GiB of storage for the lab installation and the /var directory requires a minimum of 70 GiB for the lab installation.
