...
Next lab sections rely on having a lab environment accessible in order to do the hands-on work. If you're a Red Hatter you can order a lab environment on https://insertlinktorhpdshere[RHPDS]. Otherwise, keep reading to deploy your own lab environment.
