...
We have been talking during this lab about how a ClusterInstance manifest describes the way an OpenShift cluster is going to be provisioned, while one or multiple PolicyGenTemplates describe the configuration that will be applied to the provisioned cluster. 
