...
#TODO: explain cluster templates / node templates
...
#TODO: Add more info explaining that this is done later in the lab.

WARNING: The IBI Operator requires an Installation ISO preinstalled on the host we want to deploy before creating the configuration ISO. The installation ISO and seed image process creation is described in the link:ztp-workflow.html#ibi-deployment[ZTP workflow] section.
