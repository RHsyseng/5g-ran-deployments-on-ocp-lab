...
As part of the composable OpenShift Settings the Console Operator can be enabled-disabled. The `ClusterInstance` CR allows these settings to be defined via the `installConfigOverrides`.
