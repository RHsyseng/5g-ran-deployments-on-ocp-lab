...
Policies templating is a bit different, we have a set of policy templates, known as source-crs, that we can use. This set of policies can be found https://github.com/openshift-kni/cnf-features-deploy/tree/release-4.11/ztp/source-crs[here].
