...
We described how `PolicyGenTemplate` works in detail xref:10-policygen-deepdive.adoc#policies-templating[here], so let's jump directly to the creation of the different templates.
