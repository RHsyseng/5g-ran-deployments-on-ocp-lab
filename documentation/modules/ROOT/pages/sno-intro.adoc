...
* https://docs.openshift.com/container-platform/4.12/installing/installing_sno/install-sno-preparing-to-install-sno.html[Preparing to install on a single node] in the official documentation.
