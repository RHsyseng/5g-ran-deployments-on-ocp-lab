...
podman login infra.5g-deployment.lab:8443 -u admin -p r3dh4t1!
podman run --log-driver=none --rm infra.5g-deployment.lab:8443/openshift4/ztp-site-generate-rhel8:v4.11 extract /home/ztp --tar | tar x -C ~/5g-deployment-lab/ztp-pipeline/
-----
...
[source,bash,subs="attributes+,+macros"]
-----
oc apply -k ~/5g-deployment-lab/ztp-pipeline/argocd/deployment/
-----
