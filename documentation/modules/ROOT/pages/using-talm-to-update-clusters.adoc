...
clusterversion.config.openshift.io/version   {sno-cluster-version2-cvo}    True        True          30s     Working towards {sno-cluster-version2-cvo}: 101 of 842 done (11% complete), waiting on kube-apiserver
