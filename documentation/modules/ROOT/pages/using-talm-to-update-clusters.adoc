...
WARNING: Due to an issue with the OADP Data Protection source CR because of a deprecated configuration in version 1.5 of OADP, a custom source CR must be created and referenced in the Policy. Below is shown the new source CR of OadpDataProtectionApplication.yaml stored as custom CR. On top of that the BackupStorageLocation needs to be manually set as default via a custom cr due to https://issues.redhat.com/browse/OADP-7151[this bug].
...
status:
  ...
  - reason: Complete
    ...
    type: Reconciled
EOF
cat <<EOF > ~/5g-deployment-lab/ztp-repository/site-policies/fleet/active/{openshift-release}/source-crs/custom-crs/OadpBackupStorageLocation.yaml
      ...
      - spec:
          ...
          - velero:
              ...
              objectStorage:
                ...
                prefix: velero
              provider: aws
    - path: source-crs/custom-crs/OadpBackupStorageLocation.yaml
