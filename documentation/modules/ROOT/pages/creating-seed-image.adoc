...
IMPORTANT: If below command throws an error saying: `The connection to the server api.sno-seed.5g-deployment.lab:6443 was refused - did you specify the right host or port?`. Wait up to 10 minutes, the cluster may be restarting its API.
