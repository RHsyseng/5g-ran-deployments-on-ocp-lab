...
At this point, the seed image was created and pushed to our container registry under `infra.5g-deployment.lab:8443/ibi/lab5gran:{sno-seed-version}`. The seed image is ready to be used as for new SNO clusters using the IBI installation method.